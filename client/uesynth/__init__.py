...
import uuid
import time
from uesynth import uesynth_pb2
from uesynth import uesynth_pb2_grpc
...
class AsyncUESynthClient:
                ...
                try:
                    ...
                    async with self.lock:
                        if response.HasField('image_response'):
                            ...
                            self.latest_responses['camera_transform'] = response.camera_transform
                        elif response.HasField('object_transform'):
                            self.latest_responses['object_transform'] = response.object_transform
                        elif response.HasField('objects_list'):
                            self.latest_responses['objects_list'] = response.objects_list
    ...
    async def _send_action(self, action_request: uesynth_pb2.ActionRequest, callback: Optional[Callable] = None) -> str:
    ...
    async def get_camera_location(self, camera_name: str = '') -> uesynth_pb2.GetCameraTransformResponse:
    ...
    async def set_object_transform(self, object_name: str, x: float, y: float, z: float) -> uesynth_pb2.CommandResponse:
        ...
        request = uesynth_pb2.SetObjectTransformRequest(object_name=object_name, transform=transform)
    ...
    class Camera:
        ...
        async def set_location(self, x: float, y: float, z: float, camera_name: str = '') -> str:
            ...
            """
            transform = uesynth_pb2.Transform(location=uesynth_pb2.Vector3(x=x, y=y, z=z))
            request = uesynth_pb2.SetCameraTransformRequest(camera_name=camera_name, transform=transform)
        ...
        async def set_rotation(self, pitch: float, yaw: float, roll: float, camera_name: str = '') -> str:
            ...
            Returns:
                Request ID for tracking
            """
            transform = uesynth_pb2.Transform(rotation=uesynth_pb2.Rotator(pitch=pitch, yaw=yaw, roll=roll))
            request = uesynth_pb2.SetCameraTransformRequest(camera_name=camera_name, transform=transform)
        ...
        async def create(self, camera_name: str, x: float = 0, y: float = 0, z: float = 0, 
                  pitch: float = 0, yaw: float = 0, roll: float = 0) -> str:
            ...
            request = uesynth_pb2.CreateCameraRequest(camera_name=camera_name, initial_transform=transform)
        ...
        async def get_location(self, camera_name: str = '') -> uesynth_pb2.GetCameraTransformResponse:
            """Get camera location (async unary call).
    ...
    class Capture:
        ...
        async def rgb(self, camera_name: str = '', width: int = 0, height: int = 0) -> str:
            ...
            Returns:
                Request ID for tracking
            """
            request = uesynth_pb2.CaptureRequest(camera_name=camera_name, width=width, height=height)
        ...
        async def depth(self, camera_name: str = '', width: int = 0, height: int = 0) -> str:
        ...
        async def segmentation(self, camera_name: str = '', width: int = 0, height: int = 0) -> str:
        ...
        async def rgb_direct(self, camera_name: str = '', width: int = 0, height: int = 0) -> np.ndarray:
            ...
            image = np.frombuffer(response.image_data, dtype=np.uint8).reshape(response.height, response.width, -1)
            return image
    ...
    class Objects:
        ...
        async def set_location(self, object_name: str, x: float, y: float, z: float) -> str:
        ...
        async def spawn(self, object_name: str, asset_path: str, x: float = 0, y: float = 0, z: float = 0) -> str:
            ...
            """
            transform = uesynth_pb2.Transform(location=uesynth_pb2.Vector3(x=x, y=y, z=z))
            request = uesynth_pb2.SpawnObjectRequest(object_name=object_name, asset_path=asset_path, initial_transform=transform)
        ...
        async def set_transform_direct(self, object_name: str, x: float, y: float, z: float) -> uesynth_pb2.CommandResponse:
...
class UESynthClient:
    ...
    class Camera:
        ...
        def set_location(self, x: float, y: float, z: float, camera_name: str = '') -> Any:
        ...
        def set_rotation(self, pitch: float, yaw: float, roll: float, camera_name: str = '') -> Any:
            """Set camera rotation.
        ...
        def create(self, camera_name: str, x: float = 0, y: float = 0, z: float = 0, 
                  pitch: float = 0, yaw: float = 0, roll: float = 0) -> Any:
    ...
    class Capture:
        ...
        def rgb(self, camera_name: str = '', width: int = 0, height: int = 0) -> np.ndarray:
        ...
        def depth(self, camera_name: str = '', width: int = 0, height: int = 0) -> np.ndarray:
        ...
        def segmentation(self, camera_name: str = '', width: int = 0, height: int = 0) -> np.ndarray:
    ...
    class Objects:
        ...
        def spawn(self, object_name: str, asset_path: str, x: float = 0, y: float = 0, z: float = 0) -> Any:
