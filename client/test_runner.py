...
def main():
    ...
    run_command(["uv", "run", "ruff", "format", "--check", "uesynth/", "tests/"], "Format checking")
    ...
    run_command(["uv", "run", "pytest", "tests/", "-v", "-k", "TestUESynthClient"], "Sync tests")
    
    # Run only async tests
    print("\n⚡ Running asynchronous tests only...")
    run_command(["uv", "run", "pytest", "tests/", "-v", "-k", "TestAsyncUESynthClient"], "Async tests")
    
    # Run with coverage
    print("\n📊 Running tests with coverage...")
    run_command(["uv", "run", "pytest", "tests/", "--cov=uesynth", "--cov-report=term-missing"], "Coverage report")
